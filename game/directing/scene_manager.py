...
class SceneManager:
    ...
    COLLIDE_RACKET_ACTION = CollideRacketAction(PHYSICS_SERVICE, AUDIO_SERVICE,"player_1")
    COLLIDE_RACKET_ACTION_2 = CollideRacketAction(PHYSICS_SERVICE, AUDIO_SERVICE,"player_2")
    ...
    MOVE_RACKET_ACTION = MoveRacketAction("player_1")
    MOVE_RACKET_ACTION_2 = MoveRacketAction("player_2")
    ...
    def _prepare_new_game(self, cast, script):
        ...
        self._add_racket(cast,"player_1")
        self._add_racket(cast,"player_2")
    ...
    def _add_ball(self, cast):
        ...
        y = SCREEN_HEIGHT - RACKET_HEIGHT  * 2 - BALL_HEIGHT  
        position = Point(x, y)
    ...
    def _add_bricks(self, cast):
        ...
        with open(filename, 'r') as file:
            ...
            #I colored the goal blocks black for the moment (will be easiest to code collision i think) but we can removed them if needed.
    ...
    def _add_racket(self, cast, player):
        x = 0
        y = 0
        if player == "player_1":
            x = CENTER_X - RACKET_WIDTH / 2
            y = SCREEN_HEIGHT - RACKET_HEIGHT * 2
        ...
        #need to put in another image with flipped racket
